...
::: {.callout-tip}
For reasons we will discuss below, it can be unwise to base one's estimate of effect size on the result of a single noisy study (including preliminary studies).
:::
