...
![The EDA design tool on initial population by a template file. The graph layout and connections are pre-prepared, but all details specific to an experiment remain to be filled in.](assets/images/eda-templates-3.png){#fig-eda-templates-3 width=80%}
