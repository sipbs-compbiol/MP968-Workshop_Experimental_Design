...
It's relatively easy to tell whether an animal is being well-treated, or whether an experiment is necessary. But it's not that easy to tell whether research using animals causes an _acceptable_ (i.e. _least possible_) amount of suffering.
